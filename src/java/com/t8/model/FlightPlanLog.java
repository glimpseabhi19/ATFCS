 ...
 */
@Entity
@Table(name="FLIGHTPLANLOG")
public class FlightPlanLog implements Serializable {
    ...
    @Column(name="WAYPOINT_FROM_CODE")
    private String waypointFromCode;
    @Column(name="WAYPOINT_FROM_TIME")
    private Timestamp waypointFromTime;
    @Column(name="WAYPOINT_TO_CODE")
    private String waypointToCode;
    @Column(name="WAYPOINT_TO_TIME")
    private Timestamp waypointToTime;
    @Column(name="WAYPOINT_DURATION")
    private float waypointDuration;
    @Column(name="WAYPOINT_DISTANCE")
    ...
    public String getWaypointFromCode() {
        return waypointFromCode;
    }

    public void setWaypointFromCode(String waypointFromCode) {
        this.waypointFromCode = waypointFromCode;
    }

    public Timestamp getWaypointFromTime() {
        return waypointFromTime;
    }

    public void setWaypointFromTime(Timestamp waypointFromTime) {
        this.waypointFromTime = waypointFromTime;
    }

    public String getWaypointToCode() {
        return waypointToCode;
    }

    public void setWaypointToCode(String waypointToCode) {
        this.waypointToCode = waypointToCode;
    }

    public Timestamp getWaypointToTime() {
        return waypointToTime;
    }

    public void setWaypointToTime(Timestamp waypointToTime) {
        this.waypointToTime = waypointToTime;
    }

    public float getWaypointDuration() {
        return waypointDuration;
    }

    public void setWaypointDuration(float waypointDuration) {
