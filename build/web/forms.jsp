...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"> Approach Slot Registration</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <!--  <select class="form-control" id="flightSelect" onchange="selectionchange();">
                                                 <option>--Select Flight--</option>
                                                <option>6E 449 - LUCKNOW DELHI </option>
                                                <option>6E 452 - BENGALOORU MUMBAI  </option>
                                                <option>9W2366 - JAIPUR HYDERABAD </option>
                                                <option>9W2390 - CHENNAI BHUBANESHWAR </option>
                                                <option>AI410 -	 PATNA DELHI  </option>
                                                <option>AI411 -	 DELHI LUCKNOW	 </option>
                                                <option>G8-191 - DELHI SRINAGAR	 </option>
                                                <option>G8-193 - MUMBAI BENGALOORU  </option>
                                                <option>SG 18 -	Dubai International Airport KOCHI  </option>
                                                <option>SG 2 - Colombo Bandaranaike International Airport MUMBAI  </option>

                                            </select>
                                          -->
                                          <input class="form-control" type="text" value="<%=request.getParameter("flt_code")%>" disabled="disable">
                                          <!--  <p class="help-block">List of flights scheduled to Arrive</p>-->
                                        </div>
                                                                                                           
                                     <div class="form-group">
                                            <label> Flight Type </label>
                                            <input class="form-control" type="text" value="B787 Dreamliner [Wide Body]" id="flightType" disabled="disable">
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                        <div class="form-group">
                                            <label> Flight Date Time </label>
                                            <input class="form-control" type="text" value="<%= new java.util.Date() %>" id="dateTime" disabled="disable">
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="7.5 mins" id="flightDuration" disabled="disable">
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                         <div class="form-group">
                                            <label> Airline Code </label>
                                            <input class="form-control" type="text" value="ANA" id="airlineCode" disabled="disable">
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                      <div class="form-group">
                                            <label> Aircraft Model </label>
                                            <input class="form-control" type="text" value="Boeing 757" id="aircraftModel" disabled="disable">
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                       <!-- for submit button-->
                                       <br>
                                    <!-- for submit button-->
                                    <button type="button" class="btn btn-outline btn-primary btn-lg btn-block">     Cancel    </button>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    ...
                                    <form role="form1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="<%=request.getParameter("ref_no")%>" id="reference_key" disabled="disable">
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                            <div class="form-group">
                                            <label> Flight Waypoint From - To </label>
                                            <select class="form-control">
                                                <option>-  Way points -</option>
                                                <option>WP01 - WP04</option>
                                                <option>WP02 - WP04</option>
                                                <option>WP03 - WP04</option>
                                                <option>WP04 - WP01</option>
                                                </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Assign Zone code</label>
                                            <select class="form-control">
                                            ...
                                            <!--<p class="help-block">Assign Zone code from the list</p>-->
                                         </div>
                                        <div class="form-group">
                                            <label> Available Parking Bay </label>
                                            <select class="form-control">
                                                <option>- Select Parking Bay Code -</option>
                                                <option>PB01_01</option>
                                                <option>PB02_01</option>
                                                <option>PB03_01</option>
