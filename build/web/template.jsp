                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="tables.jsp?mode=Arrival">Arrivals</a>
                                    </li>

                                    <li>
                                        <a href="tables.jsp?mode=Enroute">Enroute</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="forms.jsp">Register Landing Slots</a>
                                    </li>
                            ...
                            <li>
                                <a href="assignLandingSlot.jsp?mode=assignSlot"><i class="fa fa-check-square fa-fw"></i> Assign Landing Slot</a> 
                            </li>
                            <li>
                                <a href="notifications.jsp"><i class="fa fa-fire fa-fw"></i> Notification</a> 
                            </li>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Flights Arriving in the Next Hour </div>
                                    </div>
                                </div>
                            </div>
                            <a href="tables.jsp?mode=Arrival">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Expected On-Schedule Arrivals in Next Hour</div>
                                    </div>
                                </div>
                            </div>
                            <a href="tables.jsp?mode=Departure">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Parking Bays Allocated / Free</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Way Point & Runway Information</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-bar-chart-o fa-fw"></i> Flight Progress Chart 
